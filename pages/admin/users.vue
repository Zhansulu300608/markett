  ...
  <div class="flex min-h-screen bg-gray-50">
    ...
    <main class="flex-1 p-4 md:p-6 overflow-auto">
      ...
      <div class="flex flex-wrap items-center gap-2 mb-4 md:mb-6">
        ...
        <select v-model="filterRole" class="px-3 py-2 border rounded-lg bg-white w-full md:w-auto">
        ...
        <table class="min-w-full border-collapse table-auto">
          ...
          <tbody>
            ...
            >
              ...
              <td class="hidden lg:table-cell p-2 text-gray-600">{{ formatDate(user.createdAt) }}</td>
...
const filteredUsers = computed(() => {
  return users.value.filter(u => {
    return (
      (!search.value || u.name.toLowerCase().includes(search.value.toLowerCase()) || u.email.toLowerCase().includes(search.value.toLowerCase())) &&
